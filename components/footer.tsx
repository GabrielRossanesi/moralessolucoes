...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-[#ded7c8] bg-[#f4efe5] text-[#18150f]">
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-gold/30 to-transparent" />
      <div className="absolute -right-24 top-12 h-56 w-56 rounded-full bg-gold/10 blur-3xl" />
      <div className="absolute -left-20 bottom-10 h-48 w-48 rounded-full bg-cyanSoft/10 blur-3xl" />

      <div className="container-shell relative py-14 md:py-18">
